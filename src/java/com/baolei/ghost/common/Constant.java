...
public class Constant {
	...
	public static String PLAN_ACTION_JIACANG = "JIACANG"; //加仓

	public static String PLAN_ACTION_JUSTWIN = "JUSTWIN"; //止赢
	
	public static String EXIT_STATUS_JUSTWIN = "JUSTWIN"; //止赢
